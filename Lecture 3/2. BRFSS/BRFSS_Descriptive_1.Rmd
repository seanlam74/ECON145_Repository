...
df_smoker <- df_asthma %>%
  ...
  filter(!is.na(`_BMI5`) & `_BMI5` < 50) %>%   
  droplevels()          # remove NA or BMI > 50

sum(is.na(df_smoker$`_BMI5`))
...
# 6.4 Create a cleaned Yes/No variable for aggregation
df_state <- df_asthma %>%
